<script lang="ts">
	console.log(`\r\n _______  ___      _______  _     _  _______  _______  _______  _______  _______ \r\n|       ||   |    |       || | _ | ||       ||       ||   _   ||       ||       |\r\n|    ___||   |    |   _   || || || ||  _____||    _  ||  |_|  ||       ||    ___|\r\n|   |___ |   |    |  | |  ||       || |_____ |   |_| ||       ||       ||   |___ \r\n|    ___||   |___ |  |_|  ||       ||_____  ||    ___||       ||      _||    ___|\r\n|   |    |       ||       ||   _   | _____| ||   |    |   _   ||     |_ |   |___ \r\n|___|    |_______||_______||__| |__||_______||___|    |__| |__||_______||_______|\r\n`)
	import '../app.css'
...
<SignedIn>
	<Navbar />
	<main class="w-full h-[calc(100%-4rem)] p-4 ">
		<slot />
	</main>
</SignedIn>
<SignedOut>
